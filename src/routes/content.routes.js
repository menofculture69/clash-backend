...
contentRouter.post('/posts', requireAuth, asyncHandler((req, res) => contentController.createPublicPost(req, res)));
...
contentRouter.post('/posts/:id/like', requireAuth, asyncHandler((req, res) => contentController.like(req, res)));
contentRouter.get('/posts/:id/comments', asyncHandler((req, res) => contentController.comments(req, res)));
contentRouter.post('/posts/:id/comment', requireAuth, asyncHandler((req, res) => contentController.comment(req, res)));
contentRouter.post('/posts/:id/report', requireAuth, asyncHandler((req, res) => contentController.report(req, res)));
